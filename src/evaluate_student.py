...
for dataset in datasets:
        ...
        for k in ks:
            ...
            for compression_rate in compression_rates:
                for partition in range(k):
                    ...
                    studentmedium_checkpoint = torch.load(studentmedium_checkpoint_path)
                    ...
                    studentmedium_avg_acc += (studentmedium_checkpoint['val_acc']*(studentmedium_checkpoint['val_size'].cpu()/studentmedium_checkpoint['total_val_size']))
    ...
    plt.legend(['teacher','student_medium','student'])
plt.show()
print("Plotted")
